...
#define API_NAME_CONTROLLER_SUPPORTED_IF	"ufprog_controller_supported_if"
typedef uint32_t (UFPROG_API *api_controller_supported_if)(void);
...
typedef ufprog_status (UFPROG_API *api_device_open)(uint32_t if_type, struct json_object *config,
						    ufprog_bool thread_safe, struct ufprog_interface **outifdev);

#define API_NAME_DEVICE_FREE			"ufprog_device_free"
typedef ufprog_status (UFPROG_API *api_device_free)(struct ufprog_interface *ifdev);

#define API_NAME_DEVICE_LOCK			"ufprog_device_lock"
typedef ufprog_status (UFPROG_API *api_device_lock)(struct ufprog_interface *ifdev);

#define API_NAME_DEVICE_UNLOCK			"ufprog_device_unlock"
typedef ufprog_status (UFPROG_API *api_device_unlock)(struct ufprog_interface *ifdev);

/* Optional base APIs */
#define API_NAME_DEVICE_RESET			"ufprog_device_reset"
typedef ufprog_status (UFPROG_API *api_device_reset)(struct ufprog_interface *ifdev);

/* Must be thread-safe */
#define API_NAME_DEVICE_CANCEL_TRANSFER		"ufprog_device_cancel_transfer"
typedef ufprog_status (UFPROG_API *api_device_cancel_transfer)(struct ufprog_interface *ifdev);

#define API_NAME_SET_DEVICE_DISCONNECT_CB	"ufprog_set_device_disconnect_cb"
typedef void (UFPROG_API *ufprog_device_disconnect_cb)(struct ufprog_interface *ifdev);
typedef ufprog_status (UFPROG_API *api_set_device_disconnect_cb)(struct ufprog_interface *ifdev,
