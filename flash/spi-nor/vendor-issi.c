...
#define ISSI_F_ECC				BIT(3)
#define ISSI_F_WP_TBS				BIT(4)
...
static const struct spi_nor_wp_info is25xp010ec_wpr_3bp_tb = SNOR_WP_BP(&sr_acc, BP_2_0_TB,
	...
	SNOR_WP_ALL(  SR_TB |                   SR_BP0   ),	/* All */
	SNOR_WP_ALL(  SR_TB |          SR_BP1            ),	/* All */
...
/* IS25LP032/064/128 */
static const SNOR_DC_CONFIG(is25lp032_dc_122_cfgs, SNOR_DC_IDX_VALUE(2, 8, 133), SNOR_DC_IDX_VALUE(0, 4, 104),
			    SNOR_DC_IDX_VALUE(1, 4, 104), SNOR_DC_IDX_VALUE(3, 4, 104));

static const SNOR_DC_CONFIG(is25lp032_dc_144_cfgs, SNOR_DC_IDX_VALUE(2, 8, 133), SNOR_DC_IDX_VALUE(3, 10, 133),
			    SNOR_DC_IDX_VALUE(0, 6, 104), SNOR_DC_IDX_VALUE(1, 4, 84));

static const SNOR_DC_TABLE(is25lp032_dc_table, 3,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25lp032_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25lp032_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25lp032_dc_144_cfgs));

/* IS25WP020/040/080/016 */
static const SNOR_DC_CONFIG(is25wp020_dc_111_cfgs, SNOR_DC_VALUE(3, 133), SNOR_DC_VALUE(4, 133),
			    SNOR_DC_VALUE(5, 133), SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133),
			    SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(2, 104),
			    SNOR_DC_VALUE(1, 84));

static const SNOR_DC_CONFIG(is25wp020_dc_112_cfgs, SNOR_DC_VALUE(5, 133), SNOR_DC_VALUE(6, 133),
			    SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133),
			    SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133),
			    SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133),
			    SNOR_DC_VALUE(4, 128), SNOR_DC_VALUE(3, 115), SNOR_DC_VALUE(2, 104),
			    SNOR_DC_VALUE(1, 84));

static const SNOR_DC_CONFIG(is25wp020_dc_122_cfgs, SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133),
			    SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(5, 128),
			    SNOR_DC_VALUE(4, 115), SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 60));

static const SNOR_DC_CONFIG(is25wp020_dc_114_cfgs, SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(6, 128), SNOR_DC_VALUE(5, 115),
			    SNOR_DC_VALUE(4, 104), SNOR_DC_VALUE(3, 90), SNOR_DC_VALUE(2, 80),
			    SNOR_DC_VALUE(1, 66));

static const SNOR_DC_CONFIG(is25wp020_dc_144_cfgs, SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(8, 128),
			    SNOR_DC_VALUE(7, 115), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(5, 84),
			    SNOR_DC_VALUE(4, 70), SNOR_DC_VALUE(3, 60), SNOR_DC_VALUE(2, 50),
			    SNOR_DC_VALUE(1, 33));

static const SNOR_DC_TABLE(is25wp020_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25wp020_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25wp020_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25wp020_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25wp020_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25wp020_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25wp020_dc_144_cfgs));

/* IS25WP020D/040D/080D,IS25LP080D */
static const SNOR_DC_CONFIG(is25wp020d_dc_111_cfgs, SNOR_DC_VALUE(3, 133), SNOR_DC_VALUE(4, 133),
			    SNOR_DC_VALUE(5, 133), SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133),
			    SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(2, 104),
...
static const SNOR_DC_CONFIG(is25wp020d_dc_112_cfgs, SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(5, 133),
			    SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(3, 115), SNOR_DC_VALUE(2, 104),
			    SNOR_DC_VALUE(1, 84));

static const SNOR_DC_CONFIG(is25wp020d_dc_122_cfgs, SNOR_DC_VALUE(5, 133), SNOR_DC_VALUE(6, 133),
			    SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133),
			    SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133),
			    SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133),
			    SNOR_DC_VALUE(4, 115), SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(2, 84),
...
static const SNOR_DC_CONFIG(is25wp020d_dc_114_cfgs, SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133),
			    SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(5, 115),
			    SNOR_DC_VALUE(4, 104), SNOR_DC_VALUE(3, 90), SNOR_DC_VALUE(2, 80),
			    SNOR_DC_VALUE(1, 66));

static const SNOR_DC_CONFIG(is25wp020d_dc_144_cfgs, SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133),
			    SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133),
			    SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133),
			    SNOR_DC_VALUE(7, 115), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(5, 84),
			    SNOR_DC_VALUE(4, 70), SNOR_DC_VALUE(3, 60), SNOR_DC_VALUE(2, 50),
...
static const SNOR_DC_TABLE(is25wp020d_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25wp020d_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25wp020d_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25wp020d_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25wp020d_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25wp020d_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25wp020d_dc_144_cfgs));

/* IS25LP064D */
static const SNOR_DC_CONFIG(is25lp064d_dc_111_cfgs, SNOR_DC_VALUE(4, 166), SNOR_DC_VALUE(5, 166),
			    SNOR_DC_VALUE(6, 166), SNOR_DC_VALUE(7, 166), SNOR_DC_VALUE(8, 166),
			    SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(3, 133), SNOR_DC_VALUE(2, 120),
			    SNOR_DC_VALUE(1, 84));

static const SNOR_DC_CONFIG(is25lp064d_dc_112_cfgs, SNOR_DC_VALUE(7, 166), SNOR_DC_VALUE(8, 166),
			    SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(6, 150), SNOR_DC_VALUE(5, 140),
			    SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(3, 120), SNOR_DC_VALUE(2, 104),
			    SNOR_DC_VALUE(1, 95));

static const SNOR_DC_CONFIG(is25lp064d_dc_122_cfgs, SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166),
			    SNOR_DC_VALUE(11, 166), SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166),
			    SNOR_DC_VALUE(14, 166), SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(8, 150),
			    SNOR_DC_VALUE(7, 140), SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(5, 120),
			    SNOR_DC_VALUE(4, 104), SNOR_DC_VALUE(3, 95), SNOR_DC_VALUE(2, 80),
			    SNOR_DC_VALUE(1, 55));

static const SNOR_DC_CONFIG(is25lp064d_dc_114_cfgs, SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(9, 160), SNOR_DC_VALUE(8, 150),
			    SNOR_DC_VALUE(7, 140), SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(5, 120),
			    SNOR_DC_VALUE(4, 104), SNOR_DC_VALUE(3, 95), SNOR_DC_VALUE(2, 80),
			    SNOR_DC_VALUE(1, 70));

static const SNOR_DC_CONFIG(is25lp064d_dc_144_cfgs, SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(12, 160), SNOR_DC_VALUE(11, 150),
			    SNOR_DC_VALUE(10, 140), SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(8, 120),
			    SNOR_DC_VALUE(7, 104), SNOR_DC_VALUE(6, 90), SNOR_DC_VALUE(5, 80),
			    SNOR_DC_VALUE(4, 70), SNOR_DC_VALUE(3, 60), SNOR_DC_VALUE(2, 50),
			    SNOR_DC_VALUE(1, 33));

static const SNOR_DC_TABLE(is25lp064d_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25lp064d_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25lp064d_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25lp064d_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25lp064d_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25lp064d_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25lp064d_dc_144_cfgs));

/* IS25WP064D */
static const SNOR_DC_CONFIG(is25wp064d_dc_111_cfgs, SNOR_DC_VALUE(7, 166), SNOR_DC_VALUE(8, 166),
			    SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(6, 156), SNOR_DC_VALUE(5, 145),
			    SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(3, 122), SNOR_DC_VALUE(2, 110),
			    SNOR_DC_VALUE(1, 98));

static const SNOR_DC_CONFIG(is25wp064d_dc_112_cfgs, SNOR_DC_VALUE(8, 166), SNOR_DC_VALUE(9, 166),
			    SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166), SNOR_DC_VALUE(12, 166),
			    SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166), SNOR_DC_VALUE(15, 166),
			    SNOR_DC_VALUE(7, 156), SNOR_DC_VALUE(6, 145), SNOR_DC_VALUE(5, 133),
			    SNOR_DC_VALUE(4, 122), SNOR_DC_VALUE(3, 98), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 75));

static const SNOR_DC_CONFIG(is25wp064d_dc_122_cfgs, SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(9, 156), SNOR_DC_VALUE(8, 145),
			    SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(6, 122), SNOR_DC_VALUE(5, 110),
			    SNOR_DC_VALUE(4, 98), SNOR_DC_VALUE(3, 87), SNOR_DC_VALUE(2, 75),
			    SNOR_DC_VALUE(1, 46));

static const SNOR_DC_CONFIG(is25wp064d_dc_114_cfgs, SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166),
			    SNOR_DC_VALUE(14, 166), SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(11, 151),
			    SNOR_DC_VALUE(10, 145), SNOR_DC_VALUE(9, 140), SNOR_DC_VALUE(8, 138),
			    SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(6, 122), SNOR_DC_VALUE(5, 110),
			    SNOR_DC_VALUE(4, 98), SNOR_DC_VALUE(3, 87), SNOR_DC_VALUE(2, 75),
			    SNOR_DC_VALUE(1, 63));

static const SNOR_DC_CONFIG(is25wp064d_dc_144_cfgs, SNOR_DC_VALUE(14, 166), SNOR_DC_VALUE(15, 166),
			    SNOR_DC_VALUE(13, 162), SNOR_DC_VALUE(12, 151), SNOR_DC_VALUE(11, 139),
			    SNOR_DC_VALUE(10, 127), SNOR_DC_VALUE(9, 122), SNOR_DC_VALUE(8, 104),
			    SNOR_DC_VALUE(7, 93), SNOR_DC_VALUE(6, 81), SNOR_DC_VALUE(5, 69),
			    SNOR_DC_VALUE(4, 58), SNOR_DC_VALUE(3, 46), SNOR_DC_VALUE(2, 34),
			    SNOR_DC_VALUE(1, 23));

static const SNOR_DC_TABLE(is25wp064d_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25wp064d_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25wp064d_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25wp064d_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25wp064d_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25wp064d_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25wp064d_dc_144_cfgs));

/* IS25LP128F */
static const SNOR_DC_CONFIG(is25lp128f_dc_111_cfgs, SNOR_DC_VALUE(7, 166), SNOR_DC_VALUE(8, 166),
			    SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(6, 156), SNOR_DC_VALUE(5, 145),
			    SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(3, 122), SNOR_DC_VALUE(2, 110),
...
static const SNOR_DC_CONFIG(is25lp128f_dc_112_cfgs, SNOR_DC_VALUE(7, 166), SNOR_DC_VALUE(8, 166),
			    SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(6, 150), SNOR_DC_VALUE(5, 140),
			    SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(3, 98), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 75));

static const SNOR_DC_CONFIG(is25lp128f_dc_122_cfgs, SNOR_DC_VALUE(9, 166), SNOR_DC_VALUE(10, 166),
			    SNOR_DC_VALUE(11, 166), SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166),
			    SNOR_DC_VALUE(14, 166), SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(8, 150),
			    SNOR_DC_VALUE(7, 140), SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(5, 120),
			    SNOR_DC_VALUE(4, 104), SNOR_DC_VALUE(3, 95), SNOR_DC_VALUE(2, 80),
...
static const SNOR_DC_CONFIG(is25lp128f_dc_114_cfgs, SNOR_DC_VALUE(10, 166), SNOR_DC_VALUE(11, 166),
			    SNOR_DC_VALUE(12, 166), SNOR_DC_VALUE(13, 166), SNOR_DC_VALUE(14, 166),
			    SNOR_DC_VALUE(15, 166), SNOR_DC_VALUE(9, 156), SNOR_DC_VALUE(8, 145),
			    SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(6, 122), SNOR_DC_VALUE(5, 110),
			    SNOR_DC_VALUE(4, 98), SNOR_DC_VALUE(3, 87), SNOR_DC_VALUE(2, 75),
...
static const SNOR_DC_CONFIG(is25lp128f_dc_144_cfgs, SNOR_DC_VALUE(14, 166), SNOR_DC_VALUE(15, 166),
			    SNOR_DC_VALUE(13, 162), SNOR_DC_VALUE(12, 151), SNOR_DC_VALUE(11, 139),
			    SNOR_DC_VALUE(10, 127), SNOR_DC_VALUE(9, 122), SNOR_DC_VALUE(8, 104),
			    SNOR_DC_VALUE(7, 93), SNOR_DC_VALUE(6, 81), SNOR_DC_VALUE(5, 69),
			    SNOR_DC_VALUE(4, 58), SNOR_DC_VALUE(3, 46), SNOR_DC_VALUE(2, 34),
...
static const SNOR_DC_TABLE(is25lp128f_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25lp128f_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25lp128f_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25lp128f_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25lp128f_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25lp128f_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25lp128f_dc_144_cfgs));

/* IS25WP256D */
static const SNOR_DC_CONFIG(is25wp256d_dc_111_cfgs, SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(5, 133),
			    SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(3, 122), SNOR_DC_VALUE(2, 110),
			    SNOR_DC_VALUE(1, 98));

static const SNOR_DC_CONFIG(is25wp256d_dc_112_cfgs, SNOR_DC_VALUE(4, 133), SNOR_DC_VALUE(5, 133),
			    SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(3, 98), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 75));

static const SNOR_DC_CONFIG(is25wp256d_dc_122_cfgs, SNOR_DC_VALUE(6, 133), SNOR_DC_VALUE(7, 133),
			    SNOR_DC_VALUE(8, 133), SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(5, 122),
			    SNOR_DC_VALUE(4, 104), SNOR_DC_VALUE(3, 98), SNOR_DC_VALUE(2, 80),
			    SNOR_DC_VALUE(1, 52));

static const SNOR_DC_CONFIG(is25wp256d_dc_114_cfgs, SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(6, 122), SNOR_DC_VALUE(5, 110),
			    SNOR_DC_VALUE(4, 98), SNOR_DC_VALUE(3, 87), SNOR_DC_VALUE(2, 75),
			    SNOR_DC_VALUE(1, 63));

static const SNOR_DC_CONFIG(is25wp256d_dc_144_cfgs, SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133),
			    SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133),
			    SNOR_DC_VALUE(10, 127), SNOR_DC_VALUE(9, 122), SNOR_DC_VALUE(8, 104),
			    SNOR_DC_VALUE(7, 93), SNOR_DC_VALUE(6, 81), SNOR_DC_VALUE(5, 69),
			    SNOR_DC_VALUE(4, 58), SNOR_DC_VALUE(3, 46), SNOR_DC_VALUE(2, 34),
...
static const SNOR_DC_TABLE(is25wp256d_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25wp256d_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25wp256d_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25wp256d_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25wp256d_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25wp256d_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25wp256d_dc_144_cfgs));

/* IS25LP512M */
static const SNOR_DC_CONFIG(is25lp512m_dc_111_cfgs, SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(6, 120), SNOR_DC_VALUE(5, 115),
			    SNOR_DC_VALUE(4, 110), SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 66));

static const SNOR_DC_CONFIG(is25lp512m_dc_112_cfgs, SNOR_DC_VALUE(7, 133), SNOR_DC_VALUE(8, 133),
			    SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(6, 125), SNOR_DC_VALUE(5, 117),
			    SNOR_DC_VALUE(4, 110), SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 66));

static const SNOR_DC_CONFIG(is25lp512m_dc_122_cfgs, SNOR_DC_VALUE(9, 133), SNOR_DC_VALUE(10, 133),
			    SNOR_DC_VALUE(11, 133), SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133),
			    SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(8, 117),
			    SNOR_DC_VALUE(7, 108), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(5, 90),
			    SNOR_DC_VALUE(4, 84), SNOR_DC_VALUE(3, 66), SNOR_DC_VALUE(2, 50),
			    SNOR_DC_VALUE(1, 33));

static const SNOR_DC_CONFIG(is25lp512m_dc_114_cfgs, SNOR_DC_VALUE(10, 133), SNOR_DC_VALUE(11, 133),
			    SNOR_DC_VALUE(12, 133), SNOR_DC_VALUE(13, 133), SNOR_DC_VALUE(14, 133),
			    SNOR_DC_VALUE(15, 133), SNOR_DC_VALUE(9, 125), SNOR_DC_VALUE(8, 117),
			    SNOR_DC_VALUE(7, 110), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(5, 95),
			    SNOR_DC_VALUE(4, 84), SNOR_DC_VALUE(3, 75), SNOR_DC_VALUE(2, 66),
			    SNOR_DC_VALUE(1, 50));

static const SNOR_DC_CONFIG(is25lp512m_dc_144_cfgs, SNOR_DC_VALUE(14, 133), SNOR_DC_VALUE(15, 133),
			    SNOR_DC_VALUE(13, 125), SNOR_DC_VALUE(12, 120), SNOR_DC_VALUE(11, 117),
			    SNOR_DC_VALUE(10, 110), SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(8, 95),
			    SNOR_DC_VALUE(7, 84), SNOR_DC_VALUE(6, 75), SNOR_DC_VALUE(5, 66),
			    SNOR_DC_VALUE(4, 50), SNOR_DC_VALUE(3, 40), SNOR_DC_VALUE(2, 33),
			    SNOR_DC_VALUE(1, 25));

static const SNOR_DC_TABLE(is25lp512m_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25lp512m_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25lp512m_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25lp512m_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25lp512m_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25lp512m_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25lp512m_dc_144_cfgs));

/* IS25WP512M */
static const SNOR_DC_CONFIG(is25wp512m_dc_111_cfgs, SNOR_DC_VALUE(5, 112), SNOR_DC_VALUE(6, 112),
			    SNOR_DC_VALUE(7, 112), SNOR_DC_VALUE(8, 112), SNOR_DC_VALUE(9, 112),
			    SNOR_DC_VALUE(10, 112), SNOR_DC_VALUE(11, 112), SNOR_DC_VALUE(12, 112),
			    SNOR_DC_VALUE(13, 112), SNOR_DC_VALUE(14, 112), SNOR_DC_VALUE(15, 112),
			    SNOR_DC_VALUE(4, 110), SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 66));

static const SNOR_DC_CONFIG(is25wp512m_dc_112_cfgs, SNOR_DC_VALUE(5, 112), SNOR_DC_VALUE(6, 112),
			    SNOR_DC_VALUE(7, 112), SNOR_DC_VALUE(8, 112), SNOR_DC_VALUE(9, 112),
			    SNOR_DC_VALUE(10, 112), SNOR_DC_VALUE(11, 112), SNOR_DC_VALUE(12, 112),
			    SNOR_DC_VALUE(13, 112), SNOR_DC_VALUE(14, 112), SNOR_DC_VALUE(15, 112),
			    SNOR_DC_VALUE(4, 110), SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(2, 84),
...
static const SNOR_DC_CONFIG(is25wp512m_dc_122_cfgs, SNOR_DC_VALUE(8, 112), SNOR_DC_VALUE(9, 112),
			    SNOR_DC_VALUE(10, 112), SNOR_DC_VALUE(11, 112), SNOR_DC_VALUE(12, 112),
			    SNOR_DC_VALUE(13, 112), SNOR_DC_VALUE(14, 112), SNOR_DC_VALUE(15, 112),
			    SNOR_DC_VALUE(7, 108), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(5, 90),
			    SNOR_DC_VALUE(4, 84), SNOR_DC_VALUE(3, 66), SNOR_DC_VALUE(2, 50),
...
static const SNOR_DC_CONFIG(is25wp512m_dc_114_cfgs, SNOR_DC_VALUE(8, 112), SNOR_DC_VALUE(9, 112),
			    SNOR_DC_VALUE(10, 112), SNOR_DC_VALUE(11, 112), SNOR_DC_VALUE(12, 112),
			    SNOR_DC_VALUE(13, 112), SNOR_DC_VALUE(14, 112), SNOR_DC_VALUE(15, 112),
			    SNOR_DC_VALUE(7, 110), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(5, 95),
			    SNOR_DC_VALUE(4, 84), SNOR_DC_VALUE(3, 75), SNOR_DC_VALUE(2, 66),
...
static const SNOR_DC_CONFIG(is25wp512m_dc_144_cfgs, SNOR_DC_VALUE(10, 112), SNOR_DC_VALUE(11, 112),
			    SNOR_DC_VALUE(12, 112), SNOR_DC_VALUE(13, 112), SNOR_DC_VALUE(14, 112),
			    SNOR_DC_VALUE(15, 112), SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(8, 93),
			    SNOR_DC_VALUE(7, 84), SNOR_DC_VALUE(6, 75), SNOR_DC_VALUE(5, 66),
			    SNOR_DC_VALUE(4, 50), SNOR_DC_VALUE(3, 40), SNOR_DC_VALUE(2, 33),
			    SNOR_DC_VALUE(1, 25));

static const SNOR_DC_TABLE(is25wp512m_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25wp512m_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25wp512m_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25wp512m_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25wp512m_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25wp512m_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25wp512m_dc_144_cfgs));

/* IS25WP01G */
static const SNOR_DC_CONFIG(is25wp01g_dc_111_cfgs, SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(4, 104),
			    SNOR_DC_VALUE(5, 104), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(7, 104),
			    SNOR_DC_VALUE(8, 104), SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(10, 104),
			    SNOR_DC_VALUE(11, 104), SNOR_DC_VALUE(12, 104), SNOR_DC_VALUE(13, 104),
			    SNOR_DC_VALUE(14, 104), SNOR_DC_VALUE(15, 104), SNOR_DC_VALUE(2, 84),
			    SNOR_DC_VALUE(1, 66));

static const SNOR_DC_CONFIG(is25wp01g_dc_112_cfgs, SNOR_DC_VALUE(3, 104), SNOR_DC_VALUE(4, 104),
			    SNOR_DC_VALUE(5, 104), SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(7, 104),
			    SNOR_DC_VALUE(8, 104), SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(10, 104),
			    SNOR_DC_VALUE(11, 104), SNOR_DC_VALUE(12, 104), SNOR_DC_VALUE(13, 104),
			    SNOR_DC_VALUE(14, 104), SNOR_DC_VALUE(15, 104), SNOR_DC_VALUE(2, 84),
...
static const SNOR_DC_CONFIG(is25wp01g_dc_122_cfgs, SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(7, 104),
			    SNOR_DC_VALUE(8, 104), SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(10, 104),
			    SNOR_DC_VALUE(11, 104), SNOR_DC_VALUE(12, 104), SNOR_DC_VALUE(13, 104),
			    SNOR_DC_VALUE(14, 104), SNOR_DC_VALUE(15, 104), SNOR_DC_VALUE(5, 90),
			    SNOR_DC_VALUE(4, 84), SNOR_DC_VALUE(3, 66), SNOR_DC_VALUE(2, 50),
			    SNOR_DC_VALUE(1, 33));

static const SNOR_DC_CONFIG(is25wp01g_dc_114_cfgs, SNOR_DC_VALUE(6, 104), SNOR_DC_VALUE(7, 104),
			    SNOR_DC_VALUE(8, 104), SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(10, 104),
			    SNOR_DC_VALUE(11, 104), SNOR_DC_VALUE(12, 104), SNOR_DC_VALUE(13, 104),
			    SNOR_DC_VALUE(14, 104), SNOR_DC_VALUE(15, 104), SNOR_DC_VALUE(5, 95),
			    SNOR_DC_VALUE(4, 84), SNOR_DC_VALUE(3, 75), SNOR_DC_VALUE(2, 66),
			    SNOR_DC_VALUE(1, 50));

static const SNOR_DC_CONFIG(is25wp01g_dc_144_cfgs, SNOR_DC_VALUE(9, 104), SNOR_DC_VALUE(10, 104),
			    SNOR_DC_VALUE(11, 104), SNOR_DC_VALUE(12, 104), SNOR_DC_VALUE(13, 104),
			    SNOR_DC_VALUE(14, 104), SNOR_DC_VALUE(15, 104), SNOR_DC_VALUE(8, 93),
			    SNOR_DC_VALUE(7, 84), SNOR_DC_VALUE(6, 75), SNOR_DC_VALUE(5, 66),
			    SNOR_DC_VALUE(4, 50), SNOR_DC_VALUE(3, 40), SNOR_DC_VALUE(2, 33),
			    SNOR_DC_VALUE(1, 25));

static const SNOR_DC_TABLE(is25wp01g_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25wp01g_dc_111_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25wp01g_dc_112_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25wp01g_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25wp01g_dc_114_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25wp01g_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25wp01g_dc_144_cfgs));

/* IS25 Default */
static const SNOR_DC_CONFIG(is25_dfl_dc_11x_cfgs, SNOR_DC_IDX_VALUE(0, 8, 60));

static const SNOR_DC_CONFIG(is25_dfl_dc_122_cfgs, SNOR_DC_IDX_VALUE(0, 4, 60));

static const SNOR_DC_CONFIG(is25_dfl_dc_144_cfgs, SNOR_DC_IDX_VALUE(0, 6, 60));

static const SNOR_DC_TABLE(is25_dfl_dc_table, 15,
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_1, is25_dfl_dc_11x_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_2, is25_dfl_dc_11x_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_2_2, is25_dfl_dc_122_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_1_4, is25_dfl_dc_11x_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_1_4_4, is25_dfl_dc_144_cfgs),
			   SNOR_DC_TIMING(SPI_MEM_IO_4_4_4, is25_dfl_dc_144_cfgs));

static const SNOR_DC_CHIP_SETUP_ACC(issi_dc_acc_rr_dc4_3, &issi_rr_acc, 3, 3);
static const SNOR_DC_CHIP_SETUP_ACC(issi_dc_acc_rr_dc6_3, &issi_rr_acc, 0xf, 3);
...
static DEFINE_SNOR_ALIAS(is25lp256_alias, SNOR_ALIAS_MODEL("IS25LP256A"));
					   ...
					   struct spi_nor_flash_part_blank *bp)
{
	...
	if (snor->sfdp.bfpt_hdr->minor_ver == SFDP_REV_MINOR_B && bp->p.page_size == 512) {
		...
		bp->p.dc_chip_setup_acc = &issi_dc_acc_rr_dc6_3;
...
static const struct spi_nor_flash_part issi_parts[] = {
	...
	SNOR_PART("IS25WP020", SNOR_ID(0x9d, 0x70, 0x12), SZ_256K, /* SFDP 1.5 */
		  ...
		  SNOR_WP_RANGES(&wpr_3bp_tb),
		  SNOR_DC_INFO(&is25wp020_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
	),
	...
	SNOR_PART("IS25WP020D", SNOR_ID(0x9d, 0x70, 0x12), SZ_256K, /* SFDP 1.6 */
		  ...
		  SNOR_WP_RANGES(&wpr_3bp_tb),
		  SNOR_DC_INFO(&is25wp020d_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
	),
	...
	SNOR_PART("IS25LP032", SNOR_ID(0x9d, 0x60, 0x16), SZ_4M, /* SFDP 1.5 */
		  ...
		  SNOR_FLAGS(SNOR_F_UNIQUE_ID),
		  SNOR_VENDOR_FLAGS(ISSI_F_WP_TBS),
		  SNOR_SPI_MAX_SPEED_MHZ(133),
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xpxab_regs),
		  SNOR_DC_INFO(&is25lp032_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc4_3),
	...
	SNOR_PART("IS25WP032A", SNOR_ID(0x9d, 0x70, 0x16), SZ_4M, /* SFDP 1.5 */
		  SNOR_FLAGS(SNOR_F_UNIQUE_ID),
		  SNOR_VENDOR_FLAGS(ISSI_F_WP_TBS),
		  SNOR_SPI_MAX_SPEED_MHZ(133),
		  SNOR_OTP_INFO(&issi_otp_4),
	...
	SNOR_PART("IS25LP064DJ", SNOR_ID(0x9d, 0x60, 0x17), SZ_8M, /* SFDP 1.6, ASP */
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xpxd_16pins_regs),
		  SNOR_DC_INFO(&is25lp064d_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
		  SNOR_FIXUPS(&is25xpxab_wpr_4bp_tbs_fixups),
	),
	...
	SNOR_PART("IS25WP064A", SNOR_ID(0x9d, 0x70, 0x17), SZ_8M, /* SFDP 1.5 */
		  SNOR_FLAGS(SNOR_F_UNIQUE_ID),
		  SNOR_SPI_MAX_SPEED_MHZ(133),
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xpxa_16pins_regs),
	...
	SNOR_PART("IS25WP064DJ", SNOR_ID(0x9d, 0x70, 0x17), SZ_8M, /* SFDP 1.6, ASP */
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xpxd_16pins_regs),
		  SNOR_DC_INFO(&is25wp064d_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
		  SNOR_FIXUPS(&is25xpxab_wpr_4bp_tbs_fixups),
	),
	...
	SNOR_PART("IS25LP128FJ", SNOR_ID(0x9d, 0x60, 0x18), SZ_16M, /* SFDP 1.6, ASP */
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xpxa_16pins_regs),
		  SNOR_DC_INFO(&is25lp128f_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
		  SNOR_FIXUPS(&is25xpxab_wpr_4bp_tbs_fixups),
	),
	...
	SNOR_PART("IS25WP128*", SNOR_ID(0x9d, 0x70, 0x18), SZ_16M,
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_DC_INFO(&is25_dfl_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
	...
	SNOR_PART("IS25WP128A", SNOR_ID(0x9d, 0x70, 0x18), SZ_16M, /* SFDP 1.5 */
		  SNOR_FLAGS(SNOR_F_UNIQUE_ID),
		  SNOR_VENDOR_FLAGS(ISSI_F_WP_TBS),
		  SNOR_SPI_MAX_SPEED_MHZ(166),
		  SNOR_OTP_INFO(&issi_otp_4),
	...
	SNOR_PART("IS25LP256", SNOR_ID(0x9d, 0x60, 0x19), SZ_32M, /* SFDP 1.5, ASP */
		  SNOR_ALIAS(&is25lp256_alias), /* IS25LP256A */
		  SNOR_FLAGS(SNOR_F_UNIQUE_ID | SNOR_F_GLOBAL_UNLOCK),
		  SNOR_VENDOR_FLAGS(ISSI_F_WP_TBS),
		  SNOR_SPI_MAX_SPEED_MHZ(166),
		  SNOR_OTP_INFO(&issi_otp_4),
	...
	SNOR_PART("IS25WP256D", SNOR_ID(0x9d, 0x70, 0x19), SZ_32M, /* SFDP 1.6, ASP */
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xpxa_16pins_4b_regs),
		  SNOR_DC_INFO(&is25wp256d_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
		  SNOR_FIXUPS(&is25xpxab_wpr_4bp_tbs_fixups),
	),
	...
	SNOR_PART("IS25L*512M", SNOR_ID(0x9d, 0x60, 0x1a), SZ_64M,
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xp512m_regs),
		  SNOR_DC_INFO(&is25lp512m_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
	...
	SNOR_PART("IS25W*512M", SNOR_ID(0x9d, 0x70, 0x1a), SZ_64M,
		  SNOR_FLAGS(SNOR_F_UNIQUE_ID | SNOR_F_GLOBAL_UNLOCK | SNOR_F_META),
		  SNOR_SPI_MAX_SPEED_MHZ(112),
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xp512m_regs),
		  SNOR_DC_INFO(&is25wp512m_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
	...
	SNOR_PART("IS25W*01G", SNOR_ID(0x9d, 0x70, 0x1b), SZ_128M,
		  ...
		  SNOR_OTP_INFO(&issi_otp_4),
		  SNOR_REGS(&is25xp512m_regs),
		  SNOR_DC_INFO(&is25wp01g_dc_table),
		  SNOR_DC_CHIP_SETUP_ACC_INFO(&issi_dc_acc_rr_dc6_3),
